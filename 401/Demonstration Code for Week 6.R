# Week 6 Demonstration Code Predict 401  
...
# The average out-of-pocket expenditure for a dental tooth filling is believed 
# to be $141 if insured. It is believed the actual average expenditure is greater
# than $141.  To test this assertion, a random sample of size 32 and the resulting
# out-of-pocket expenditures is recorded.  The population standard deviation is $30.
# Test the assertion at the 5% level, assuming the population is normally distributed.
...
# In this example we will compare the population variance to the sample variance.  
# The population standard deviation is $30.  The sample standard deviation is 
# 23.98586 with 31 degrees of freedom.  
...
# Consider the following.  Are containers underfilled?  The nominal filling level  
# is an average of 12 oz.  An unacceptable filling level is a average of 11.96 oz.
