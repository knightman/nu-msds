# Week 5 Demonstration Code Predict 401  
...
# single populations will be given.  Refer to Business Statistics.

# A random sample of size 39 is taken from a population of 200 members.  The 
# sample mean is 66 and the population standard deviation is 11.  Construct a 
# 96% confidence interval to estimate the population mean.  What is the point 
...
# Use the data below to construct a confidence interval for the population mean.  
...
# Construct a 92% confidence interval for the proportion of all fast-growing small
# companies that have a management succession plan, given that only 51% of a 
# sample of 210 chief executives have such a plan.
...
# The average hourly wage for a production worker is $19.58.  A sample of 25 
# workers results in a sample standard deviation of $1.12.  Construct a 95% 
# confidence interval for the population variance, and then a confidence interval
...
# To convert to standard deviations, take the sqrt.
...
# A researcher wants to be within 0.05 of the actual proportion in a population 
# with 99% confidence.  With no prior information to go on, what sample size  
# should be used?  This is a straightforward use of R as a calculator.
