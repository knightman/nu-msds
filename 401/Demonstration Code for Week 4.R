# Week 4 Demonstration Code Predict 401 
...
# If the probability is 0.6 of success, with a sample of 120 what is the 
# probability that 60 or fewer successes occur?  
# Using pbinom() an exact calculation can be made. 

pbinom(60, 120, 0.6, lower.tail = TRUE)

# A comparable calculation in Business Statistics resulted in 0.0125.
